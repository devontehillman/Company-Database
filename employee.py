...
class Salaried(Employee):
    ...
    def __repr__(self):
        return super().__repr__(), f',{self._yearly}'
...
class Executive(Salaried):
    ...
    def __repr__(self):
        return super().__repr__(), f',{self._role}'
...
class Manager(Salaried):
    ...
    def __repr__(self):
        return super().__repr__(), f',{self._department}'
...
class Hourly(Employee):
    ...
    def __repr__(self):
        return super().__repr__(), f',{self._hourly}'
...
class Permanent(Hourly):
    ...
    def hired_date(self, hired_date):
        if isinstance(hired_date, str):
            hire_date = datetime.datetime.strptime(hired_date, '%Y-%m-%d %H: %M: %S')
            self._hired_date = hire_date
        else:
            raise ValueError("Invalid date")

    def __repr__(self):
        return {super().__repr__()}, f',{self._hired_date}'
...
class Temp(Hourly):
    ...
    def last_day(self, last_day):
        if last_day and isinstance(last_day, str):
            """
    ...
    def __repr__(self):
        return {super().__repr__()}, f',{self._last_day}'
